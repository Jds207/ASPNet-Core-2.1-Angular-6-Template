...
namespace ASPNET
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("ASPNET"));
            ...
            //add this when using webfarm to bypassing storing keys on the local machine
          ...
          //.PersistKeysToFileSystem(new DirectoryInfo(@"\\server\path\"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "ASPNET API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - ASPNET";
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ASPNET API V1");
            });
