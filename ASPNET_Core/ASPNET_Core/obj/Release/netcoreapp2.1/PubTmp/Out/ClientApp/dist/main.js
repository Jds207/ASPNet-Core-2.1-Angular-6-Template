...
var routes = [
    { path: "", component: _components_home_home_component__WEBPACK_IMPORTED_MODULE_3__["HomeComponent"], canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]], data: { title: "Home" } },
    { path: "login", component: _components_login_login_component__WEBPACK_IMPORTED_MODULE_2__["LoginComponent"], data: { title: "Login" } },
    { path: "customers", component: _components_customers_customers_component__WEBPACK_IMPORTED_MODULE_4__["CustomersComponent"], canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]], data: { title: "Customers" } },
    { path: "products", component: _components_products_products_component__WEBPACK_IMPORTED_MODULE_5__["ProductsComponent"], canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]], data: { title: "Products" } },
    { path: "orders", component: _components_orders_orders_component__WEBPACK_IMPORTED_MODULE_6__["OrdersComponent"], canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]], data: { title: "Orders" } },
    { path: "settings", component: _components_settings_settings_component__WEBPACK_IMPORTED_MODULE_7__["SettingsComponent"], canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]], data: { title: "Settings" } },
...
var AppRoutingModule = /** @class */ (function () {
    ...
    AppRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [_services_auth_service__WEBPACK_IMPORTED_MODULE_10__["AuthService"], _services_auth_guard_service__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]]
        })
    ], AppRoutingModule);
...
/* harmony import */ var _app_error_handler__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./app-error.handler */ "./src/app/app-error.handler.ts");
/* harmony import */ var _services_app_title_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./services/app-title.service */ "./src/app/services/app-title.service.ts");
/* harmony import */ var _services_app_translation_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./services/app-translation.service */ "./src/app/services/app-translation.service.ts");
/* harmony import */ var _services_configuration_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./services/configuration.service */ "./src/app/services/configuration.service.ts");
...
/* harmony import */ var _services_local_store_manager_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./services/local-store-manager.service */ "./src/app/services/local-store-manager.service.ts");
/* harmony import */ var _services_endpoint_factory_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./services/endpoint-factory.service */ "./src/app/services/endpoint-factory.service.ts");
/* harmony import */ var _services_notification_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./services/notification.service */ "./src/app/services/notification.service.ts");
/* harmony import */ var _services_notification_endpoint_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./services/notification-endpoint.service */ "./src/app/services/notification-endpoint.service.ts");
/* harmony import */ var _services_account_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./services/account.service */ "./src/app/services/account.service.ts");
/* harmony import */ var _services_account_endpoint_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./services/account-endpoint.service */ "./src/app/services/account-endpoint.service.ts");
/* harmony import */ var _directives_equal_validator_directive__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./directives/equal-validator.directive */ "./src/app/directives/equal-validator.directive.ts");
/* harmony import */ var _directives_last_element_directive__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./directives/last-element.directive */ "./src/app/directives/last-element.directive.ts");
...
/* harmony import */ var _directives_bootstrap_tab_directive__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./directives/bootstrap-tab.directive */ "./src/app/directives/bootstrap-tab.directive.ts");
/* harmony import */ var _directives_bootstrap_toggle_directive__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./directives/bootstrap-toggle.directive */ "./src/app/directives/bootstrap-toggle.directive.ts");
/* harmony import */ var _directives_bootstrap_select_directive__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./directives/bootstrap-select.directive */ "./src/app/directives/bootstrap-select.directive.ts");
/* harmony import */ var _directives_bootstrap_datepicker_directive__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./directives/bootstrap-datepicker.directive */ "./src/app/directives/bootstrap-datepicker.directive.ts");
/* harmony import */ var _pipes_group_by_pipe__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./pipes/group-by.pipe */ "./src/app/pipes/group-by.pipe.ts");
/* harmony import */ var _components_app_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./components/app.component */ "./src/app/components/app.component.ts");
...
/* harmony import */ var _components_customers_customers_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./components/customers/customers.component */ "./src/app/components/customers/customers.component.ts");
/* harmony import */ var _components_products_products_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./components/products/products.component */ "./src/app/components/products/products.component.ts");
/* harmony import */ var _components_orders_orders_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./components/orders/orders.component */ "./src/app/components/orders/orders.component.ts");
/* harmony import */ var _components_settings_settings_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./components/settings/settings.component */ "./src/app/components/settings/settings.component.ts");
...
/* harmony import */ var _components_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./components/not-found/not-found.component */ "./src/app/components/not-found/not-found.component.ts");
/* harmony import */ var _components_controls_banner_demo_component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./components/controls/banner-demo.component */ "./src/app/components/controls/banner-demo.component.ts");
/* harmony import */ var _components_controls_todo_demo_component__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ./components/controls/todo-demo.component */ "./src/app/components/controls/todo-demo.component.ts");
/* harmony import */ var _components_controls_statistics_demo_component__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ./components/controls/statistics-demo.component */ "./src/app/components/controls/statistics-demo.component.ts");
/* harmony import */ var _components_controls_notifications_viewer_component__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ./components/controls/notifications-viewer.component */ "./src/app/components/controls/notifications-viewer.component.ts");
/* harmony import */ var _components_controls_search_box_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./components/controls/search-box.component */ "./src/app/components/controls/search-box.component.ts");
/* harmony import */ var _components_controls_user_info_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./components/controls/user-info.component */ "./src/app/components/controls/user-info.component.ts");
/* harmony import */ var _components_controls_user_preferences_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ./components/controls/user-preferences.component */ "./src/app/components/controls/user-preferences.component.ts");
/* harmony import */ var _components_controls_users_management_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ./components/controls/users-management.component */ "./src/app/components/controls/users-management.component.ts");
/* harmony import */ var _components_controls_roles_management_component__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ./components/controls/roles-management.component */ "./src/app/components/controls/roles-management.component.ts");
/* harmony import */ var _components_controls_role_editor_component__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(/*! ./components/controls/role-editor.component */ "./src/app/components/controls/role-editor.component.ts");
/* harmony import */ var _components_my_nav_my_nav_component__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(/*! ./components/my-nav/my-nav.component */ "./src/app/components/my-nav/my-nav.component.ts");
/* harmony import */ var _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(/*! @angular/cdk/layout */ "./node_modules/@angular/cdk/esm5/layout.es5.js");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
            ...
            imports: [
                ...
                _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateModule"].forRoot({
                    loader: {
                        ...
                        useClass: _services_app_translation_service__WEBPACK_IMPORTED_MODULE_17__["TranslateLanguageLoader"]
                    }
                }),
                ...
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatAutocompleteModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatBadgeModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatBottomSheetModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatButtonModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatButtonToggleModule"],
                ...
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatChipsModule"],
                ...
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatDividerModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatExpansionModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatGridListModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatIconModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatInputModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatListModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatMenuModule"],
                ...
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatProgressBarModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatProgressSpinnerModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatRadioModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatRippleModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatSelectModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatSidenavModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatSliderModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatSlideToggleModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatSnackBarModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatSortModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatStepperModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatTableModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatTabsModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatToolbarModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatTooltipModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_55__["MatTreeModule"],
            ],
            declarations: [
                _components_app_component__WEBPACK_IMPORTED_MODULE_34__["AppComponent"],
                ...
                _components_customers_customers_component__WEBPACK_IMPORTED_MODULE_37__["CustomersComponent"],
                _components_products_products_component__WEBPACK_IMPORTED_MODULE_38__["ProductsComponent"],
                _components_orders_orders_component__WEBPACK_IMPORTED_MODULE_39__["OrdersComponent"],
                _components_settings_settings_component__WEBPACK_IMPORTED_MODULE_40__["SettingsComponent"],
                _components_controls_users_management_component__WEBPACK_IMPORTED_MODULE_50__["UsersManagementComponent"], _components_controls_user_info_component__WEBPACK_IMPORTED_MODULE_48__["UserInfoComponent"], _components_controls_user_preferences_component__WEBPACK_IMPORTED_MODULE_49__["UserPreferencesComponent"],
                _components_controls_roles_management_component__WEBPACK_IMPORTED_MODULE_51__["RolesManagementComponent"], _components_controls_role_editor_component__WEBPACK_IMPORTED_MODULE_52__["RoleEditorComponent"],
                _components_about_about_component__WEBPACK_IMPORTED_MODULE_41__["AboutComponent"],
                _components_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_42__["NotFoundComponent"],
                _components_controls_notifications_viewer_component__WEBPACK_IMPORTED_MODULE_46__["NotificationsViewerComponent"],
                _components_controls_search_box_component__WEBPACK_IMPORTED_MODULE_47__["SearchBoxComponent"],
                _components_controls_statistics_demo_component__WEBPACK_IMPORTED_MODULE_45__["StatisticsDemoComponent"], _components_controls_todo_demo_component__WEBPACK_IMPORTED_MODULE_44__["TodoDemoComponent"], _components_controls_banner_demo_component__WEBPACK_IMPORTED_MODULE_43__["BannerDemoComponent"],
                _directives_equal_validator_directive__WEBPACK_IMPORTED_MODULE_26__["EqualValidator"],
                _directives_last_element_directive__WEBPACK_IMPORTED_MODULE_27__["LastElementDirective"],
                _directives_autofocus_directive__WEBPACK_IMPORTED_MODULE_28__["AutofocusDirective"],
                _directives_bootstrap_tab_directive__WEBPACK_IMPORTED_MODULE_29__["BootstrapTabDirective"],
                _directives_bootstrap_toggle_directive__WEBPACK_IMPORTED_MODULE_30__["BootstrapToggleDirective"],
                _directives_bootstrap_select_directive__WEBPACK_IMPORTED_MODULE_31__["BootstrapSelectDirective"],
                _directives_bootstrap_datepicker_directive__WEBPACK_IMPORTED_MODULE_32__["BootstrapDatepickerDirective"],
                _pipes_group_by_pipe__WEBPACK_IMPORTED_MODULE_33__["GroupByPipe"],
                _components_my_nav_my_nav_component__WEBPACK_IMPORTED_MODULE_53__["MyNavComponent"]
            ],
            providers: [
                { provide: 'BASE_URL', useFactory: getBaseUrl },
                { provide: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ErrorHandler"], useClass: _app_error_handler__WEBPACK_IMPORTED_MODULE_15__["AppErrorHandler"] },
                _services_alert_service__WEBPACK_IMPORTED_MODULE_19__["AlertService"],
                _services_configuration_service__WEBPACK_IMPORTED_MODULE_18__["ConfigurationService"],
                _services_app_title_service__WEBPACK_IMPORTED_MODULE_16__["AppTitleService"],
                _services_app_translation_service__WEBPACK_IMPORTED_MODULE_17__["AppTranslationService"],
                _services_notification_service__WEBPACK_IMPORTED_MODULE_22__["NotificationService"],
                _services_notification_endpoint_service__WEBPACK_IMPORTED_MODULE_23__["NotificationEndpoint"],
                _services_account_service__WEBPACK_IMPORTED_MODULE_24__["AccountService"],
                _services_account_endpoint_service__WEBPACK_IMPORTED_MODULE_25__["AccountEndpoint"],
                _services_local_store_manager_service__WEBPACK_IMPORTED_MODULE_20__["LocalStoreManager"],
                _services_endpoint_factory_service__WEBPACK_IMPORTED_MODULE_21__["EndpointFactory"]
            ],
            bootstrap: [_components_app_component__WEBPACK_IMPORTED_MODULE_34__["AppComponent"]]
        })
    ], AppModule);
    return AppModule;
}());
...
module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(storageManager, toastaService, toastaConfig, accountService, alertService, notificationService, appTitleService, authService, translationService, configurations, router) {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_local_store_manager_service__WEBPACK_IMPORTED_MODULE_7__["LocalStoreManager"], ngx_toasta__WEBPACK_IMPORTED_MODULE_2__["ToastaService"], ngx_toasta__WEBPACK_IMPORTED_MODULE_2__["ToastaConfig"],
...
var BannerDemoComponent = /** @class */ (function () {
    function BannerDemoComponent() {
        this.banner1 = __webpack_require__(/*! ../../assets/images/demo/banner1.png */ "./src/app/assets/images/demo/banner1.png");
        this.banner2 = __webpack_require__(/*! ../../assets/images/demo/banner2.png */ "./src/app/assets/images/demo/banner2.png");
        this.banner3 = __webpack_require__(/*! ../../assets/images/demo/banner3.png */ "./src/app/assets/images/demo/banner3.png");
        this.banner4 = __webpack_require__(/*! ../../assets/images/demo/banner4.png */ "./src/app/assets/images/demo/banner4.png");
    }
    BannerDemoComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'banner-demo',
            template: __webpack_require__(/*! ./banner-demo.component.html */ "./src/app/components/controls/banner-demo.component.html")
        })
    ], BannerDemoComponent);
...
/* harmony import */ var _models_user_login_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../models/user-login.model */ "./src/app/models/user-login.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        this.authService.login(this.userLogin.email, this.userLogin.password, this.userLogin.rememberMe)
            ...
            if (_services_utilities__WEBPACK_IMPORTED_MODULE_4__["Utilities"].checkNoNetwork(error)) {
                ...
                if (errorMessage)
                    ...
                    _this.alertService.showStickyMessage("Unable to login", "An error occured whilst logging in, please try again later.\nError: " + _services_utilities__WEBPACK_IMPORTED_MODULE_4__["Utilities"].getResponseBody(error), _services_alert_service__WEBPACK_IMPORTED_MODULE_1__["MessageSeverity"].error, error);
            }
            setTimeout(function () {
                _this.isLoading = false;
            }, 500);
...
/***/ "./src/app/components/my-nav/my-nav.component.css":
/*!********************************************************!*\
  !*** ./src/app/components/my-nav/my-nav.component.css ***!
  \********************************************************/
/*! no static exports found */
...
var MyNavComponent = /** @class */ (function () {
    function MyNavComponent(breakpointObserver, accountService) {
    ...
    Object.defineProperty(MyNavComponent.prototype, "canViewCustomers", {
        get: function () {
            return this.accountService.userHasPermission(_models_permission_model__WEBPACK_IMPORTED_MODULE_4__["Permission"].viewUsersPermission); //eg. viewCustomersPermission
        },
        enumerable: true,
        configurable: true
    });
    MyNavComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./my-nav.component.css */ "./src/app/components/my-nav/my-nav.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_1__["BreakpointObserver"], _services_account_service__WEBPACK_IMPORTED_MODULE_3__["AccountService"]])
    ], MyNavComponent);
...
var SettingsComponent = /** @class */ (function () {
    ...
    SettingsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _services_account_service__WEBPACK_IMPORTED_MODULE_4__["AccountService"]])
    ], SettingsComponent);
...
var AccountEndpoint = /** @class */ (function (_super) {
    ...
    AccountEndpoint.prototype.getUserEndpoint = function (userId) {
        ...
        return this.http.get(endpointUrl, this.getRequestHeaders()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
    ...
    AccountEndpoint.prototype.getNewUserEndpoint = function (userObject) {
        var _this = this;
        return this.http.post(this.usersUrl, JSON.stringify(userObject), this.getRequestHeaders()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
    ...
    AccountEndpoint.prototype.getUpdateUserEndpoint = function (userObject, userId) {
        var _this = this;
        var endpointUrl = userId ? this.usersUrl + "/" + userId : this.currentUserUrl;
        return this.http.put(endpointUrl, JSON.stringify(userObject), this.getRequestHeaders()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
    ...
    AccountEndpoint.prototype.getPatchUpdateUserEndpoint = function (valueOrPatch, opOrUserId, path, from, userId) {
        ...
        return this.http.patch(endpointUrl, JSON.stringify(patchDocument), this.getRequestHeaders()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
    ...
    AccountEndpoint.prototype.getUserPreferencesEndpoint = function () {
        var _this = this;
        return this.http.get(this.currentUserPreferencesUrl, this.getRequestHeaders()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
    ...
    AccountEndpoint.prototype.getUpdateUserPreferencesEndpoint = function (configuration) {
        var _this = this;
        return this.http.put(this.currentUserPreferencesUrl, JSON.stringify(configuration), this.getRequestHeaders()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
    ...
    AccountEndpoint.prototype.getUnblockUserEndpoint = function (userId) {
        ...
        return this.http.put(endpointUrl, null, this.getRequestHeaders()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
    ...
    AccountEndpoint.prototype.getNewRoleEndpoint = function (roleObject) {
        var _this = this;
        return this.http.post(this.rolesUrl, JSON.stringify(roleObject), this.getRequestHeaders()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
    ...
    AccountEndpoint.prototype.getUpdateRoleEndpoint = function (roleObject, roleId) {
        var _this = this;
        var endpointUrl = this.rolesUrl + "/" + roleId;
        return this.http.put(endpointUrl, JSON.stringify(roleObject), this.getRequestHeaders()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
    ...
    AccountEndpoint.prototype.getPermissionsEndpoint = function () {
        var _this = this;
        return this.http.get(this.permissionsUrl, this.getRequestHeaders()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
...
var AccountService = /** @class */ (function () {
    ...
    AccountService.prototype.updateRole = function (role) {
        ...
        if (role.id) {
            ...
            return this.accountEndpoint.getRoleByRoleNameEndpoint(role.name).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(function (foundRole) {
...
var ConfigurationService = /** @class */ (function () {
    ...
    ConfigurationService.appVersion = "2.6.1";
...
module.exports = __webpack_require__(/*! C:\GitHub\CTI_Admin\CTI_Admin\CTI_Admin\ClientApp\src\main.ts */"./src/main.ts");
